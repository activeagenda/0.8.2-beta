        ...
        case 'delete':
            ...
            if(count($cells) > 0){
                $firstCell = array(
                    ...
                    'id'=>$returnRowID,
                    'innerHTML'=>"
<a class=\"l\" href=\"#\" onclick=\"window.open('frames_popup.php?dest=edit&mdl={$subModuleID}&rid={$returnRowID}', '', 'toolbar=0,resizable=1')\"><img src=\"$theme_web/img/grid_fulledit.gif\" title=\"". gettext("Full Edit (in new window)"). "\"/></a>&nbsp;<a class=\"l\" href=\"javascript:editRow('$returnRowID')\"><img src=\"$theme_web/img/grid_quickedit.gif\" title=\"".gettext("Quick Edit")."\"/></a>"
                );
