...
if (!file_exists($listFieldsFileName)){
    trigger_error("Could not find grid file '$listFieldsFileName'.", E_USER_ERROR);
}
...
if(!empty($_GET['shortcut'])){
    ...
    case 'set':
        SaveDesktopShortCut($User->PersonID, $scTitle, $linkHere, 'List', $ModuleID);
        break;
    case 'remove':
