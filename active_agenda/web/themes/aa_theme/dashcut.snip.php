...
?>
        <script language="JavaScript" src="js/dashcut.js"></script>
        <div class="ds">
            ...
            <div id="dash_shortcutForm" style="display:none">
                ...
                <input type="button" onclick="dash_saveShortcut('<?php echo $linkHere;?>')" value="Save" class="btn" />
                <input type="button" onclick="dash_hideShortcutForm()" value="Cancel" class="btn" />
            </div>
        </div>