...
<img src="'.$theme_web.'/img/calendar.gif" id="cal_%1$s" style="cursor: pointer;" title="Date selector" height="16" width="16" />');
...
define('FORM_FILTER_CB_HTML', '<script language="JavaScript1.2">
<!-- 
    //[js:]
...
-->
    ...
    %8$s
    <select class="edt %10$s" name="%2$s" id="id%2$s" onchange="%7$s"></select>
    <script language="JavaScript1.2">
    <!--
    //[js:]
...
define('FORM_PERSON_CB_HTML', '
    ...
    %6$s <SELECT class="edt" id="%2$s_org" name="%2$s_org" onchange="ReloadPeople(\'%1$s\', \'%2$s\', this.value, ar%2$sPeople)">
    </SELECT><br>
    %5$s <SELECT class="edt" id="%2$s" name="%2$s">
    </SELECT>
    <script language="JavaScript1.2">
    <!--
    //[js:]
...
define('FORM_FINDMODE_TEXT_HTML', '
    <input class="edta" type="text" name="fm_%1$s" id="fm_%1$s" value="" size="5" title="Type a few characters to select an item in the list to the right." onkeyup="filteryText(event,this.value,this.form.%1$s)" />
');
...
'<div class="gridtitle">
    <a href="#" title="Open Module in new window" onclick="window.open(\'%3$s\', \'\', \'toolbar=0,resizable=1\')">
        <img src="'.$theme_web.'/img/open_new_window.gif" height="16" width="16" /></a>&nbsp;&nbsp;<a href="%2$s" title="Open Module in same window">
        %1$s
    </a>
    %4$s
</div>');
...
//parameters: content
define('VIEWGRID_TABLE', '<table class="list" cellpadding="2" cellspacing="1" width="100%%">%s</table>');
...
define('GRID_NAV_ONFIRSTPAGE', '<img src="%1$s/img/go-first-grey.png" title="' . gettext("This is the first page") . '" height="16" width="16" />&nbsp;&nbsp;<img src="%1$s/img/go-previous-grey.png" title="' . gettext("This is the first page") . '" height="16" width="16" /> &nbsp; ');
//parameters: firstLink, prevLink, theme_web
define('GRID_NAV_PREVLINKS', '<a class="gridnav_first" href="%1$s"><img src="%3$s/img/go-first.png" title="' . gettext("Go to the first page") . '" height="16" width="16" /></a>&nbsp;&nbsp;<a class="p" href="%2$s"><img src="%3$s/img/go-previous.png" title="' . gettext("Go to the previous page") . '" height="16" width="16" /></a> &nbsp; ');

//parameters: theme_web
define('GRID_NAV_ONLASTPAGE', ' &nbsp; <img src="%1$s/img/go-next-grey.png" title="' . gettext("This is the last page") . '" height="16" width="16" />&nbsp;&nbsp;<img src="%1$s/img/go-last-grey.png" title="' . gettext("This is the last page") . '" height="16" width="16" />');
//parameters: nextLink, lastLink, theme_web
define('GRID_NAV_NEXTLINKS', ' &nbsp; <a class="gridnav_first" href="%1$s"><img src="%3$s/img/go-next.png" title="' . gettext("Go to the next page") . '" height="16" width="16" /></a>&nbsp;&nbsp;<a class="p" href="%2$s"><img src="%3$s/img/go-last.png" title="' . gettext("Go to the last page") . '" height="16" width="16" /></a>');
...
define('EDITGRID_HEADER_CELL_ADDNEW', '<th class="l" id="loc0"><a class="lh" href="javascript:editRow(\'0\');" title="%s"><img src="%s/img/grid_quickadd.gif" height="16" width="16" /></a></th>');
...
//parameters: 1 link, 2 CSS class, 3 theme location, 4 alt message, 5 rowID, 6 <not used>
define('LIST_GRID_NAVLINK', '<a class="%2$s" href="%1$s" id="vw%5$s">
    <img src="%3$s/img/list_viewrecord.gif" alt="%4$s" height="16" width="16" />
</a>%6$s');

//parameters: 1 link, 2 CSS class, 3 theme location, 4 alt message, 5 rowID, 6 <not used>
define('VIEW_GRID_NAVLINK', '<a class="%2$s" href="#" id="fv%5$s" title="%4$s" onclick="window.open(\'%1$s\')"><img src="%3$s/img/record_new_window.gif" alt="%4$s" height="16" width="16" /></a>%6$s');

//parameters: 1 link, 2 CSS class, 3 theme location, 4 alt message, 5 rowID, 6 js alt message
define('EDIT_GRID_NAVLINK', 
'<a class="%2$s" href="#" id="fe%5$s" title="%4$s" onclick="window.open(\'%1$s\')"><img src="%3$s/img/grid_fulledit.gif" alt="%4$s" height="16" width="16" /></a>&nbsp;<a class="%2$s" id="qe%5$s" title="%6$s" href="javascript:editRow(\'%5$s\')"><img src="%3$s/img/grid_quickedit.gif" alt="%6$s"/></a>');

//parameters: 1 <not used>, 2 CSS class, 3 theme location, 4 <not used>, 5 rowID, 6 js alt message
define('EDIT_GRID_NAVLINK_NOFULLEDIT', '<a class="%2$s" id="qe%5$s" title="%6$s" href="javascript:editRow(\'%5$s\')"><img src="%3$s/img/grid_quickedit.gif" alt="%6$s" height="16" width="16" /></a>%1$s%4$s');
